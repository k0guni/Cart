        ...
        if len(corners) > 0:
                ...
                if drawaxes:
                        for i in range(0, len(ids)):
                                ...
                                for coord in array_3d:                                        
                                        for x,y in coord:
                                                if x <= 150:
                                                        ...
                                                        rig += 1
                                if rig == 4 and rev < 170 and rev > -170:
                                        ...
                                        print("right")
                                        continue
                                elif lef == 4 and rev < 170 and rev > -170:
                                        for i in range(1,13,3):
                                               left(i)
                                        left(20)
                                        time.sleep(1)
                                ...
                                if rev >= 170 and cwflag > 2:
                                        cwflag = 1
                                        forward(20)
                                        time.sleep(1)
                                        ccwflag = 2
                                        continue
                                elif rev <= -170 and ccwflag > 2:
                                        ccwflag = 1
                                        forward(20)
                                        time.sleep(1)
                                        cwflag = 2
                ...
                if cwflag==1 or ccwflag==1:
                        forward(20)
                        time.sleep(8)
                elif cwflag>1 and cwflag<13:
                        cw(24)
                        time.sleep(0.2)
                        cwflag += 1
                elif cwflag == 13:
