        ...
        if Rot == 0:
            if distances[0] < 12:
                if (distances[1]-distances[0])>=2.5 and (distances[1]-distances[0])<=50:
                    print("if dis0")
                    ccw(12)
                    while (distances[1]-distances[0])>=1.5 :
                        distances = [sensor.getDistance() for sensor in sensors]
                ...
                if (distances[0]-distances[1])>=2.5 and (distances[0]-distances[1])<=50:
                    print("if dis1")
                    cw(12)
                    while (distances[0]-distances[1])>=1.5 :
                        distances = [sensor.getDistance() for sensor in sensors]
                        time.sleep(0.02)
                    stop()                     
                else:
                ...
                if (distances[3]-distances[2])>=2.5 and  (distances[3]-distances[2])<=50:
                    print("if dis2")
                    ccw(12)
                    while (distances[3]-distances[2])>=1.5 :
                        distances = [sensor.getDistance() for sensor in sensors]
                        time.sleep(0.02)
                    stop()                     
                else:
                ...
                if (distances[2]-distances[3])>=2.5 or (distances[2]-distances[3])<=50:
                    print("if dis3")
                    cw(12)
                    while (distances[2]-distances[3])>=1.5 :
                        distances = [sensor.getDistance() for sensor in sensors]
                        time.sleep(0.02)
                    stop()                     
                else:
