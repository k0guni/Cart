    ...
    while True:
        ...
        if Rot == 0:
            if distances[0] < 12:
                ...
                if (distances[3]-distances[2])>=2.5 and  (distances[3]-distances[2])<=50:
                    print("if dis2")
                    ccw(12)
                    while (distances[3]-distances[2])>=2.5 :
                        distances = [sensor.getDistance() for sensor in sensors]
                        time.sleep(0.02)
                    stop()                     
                else:
                ...
                if (distances[2]-distances[3])>=2.5 or (distances[2]-distances[3])<=50:
                    print("if dis3")
                    cw(12)
                    while (distances[2]-distances[3])>=2.5 :
                        distances = [sensor.getDistance() for sensor in sensors]
                        time.sleep(0.02)
                    stop()                     
                else:
        ...
        if len(corners) > 0:
            if drawaxes:
                for i in range(0, len(ids)):
                    ...
                    if Rot == 1:
                        if rev >= -80 and rev <= 80:
                            cwflag = 0
                            ccwflag = 0
                            # if rev <= -30:
                            #     ccw(13)
                            #     while rev >= -30 and rev <= 30:
                            #         time.sleep(0.02)
                            # elif rev >= 30:
                            #     cw(13)
                            #     while rev >= -30 and rev <= 30:
                            ...
                            if cwflag>1 and cwflag<40:
                                    print("6")
                                    cv2.imwrite('/home/ubuntu/ex_code/image/img{}.jpg'.format(cwflag),frame)
                                    cw(14)
                                    time.sleep(rev_time)
                                    stop()
                                    time.sleep(0.001)
                                    ...
                                    stop()
                                    Rot = 0
                            elif ccwflag>1 and ccwflag<40:
                                    print("8")
                                    cv2.imwrite('/home/ubuntu/ex_code/image/img{}.jpg'.format(ccwflag),frame)
                                    ccw(14)
                                    time.sleep(rev_time)
                                    stop()
                                    time.sleep(0.001)
                        ...
                        if rev >= 160 and ccwflag == 0:
                                cv2.imwrite('/home/ubuntu/ex_code/RL/ccw.jpg'.format(cwflag),frame)
                                print("1")
                                print("rev:{}".format(rev))
                                print("dist:{}".format(distcam))                                        
                                forward(18)
                                ...
                                ccwflag = 2
                                continue
                        elif rev <= -150 and cwflag == 0:
                                cv2.imwrite('/home/ubuntu/ex_code/RL/cw.jpg'.format(cwflag),frame)
                                print("2")
                                print("rev:{}".format(rev))
                                print("dist:{}".format(distcam)) 
                                forward(18)
